...
public class EntitySyncContext {
	...
	public void saveFinalSyncResults() throws SyncDataErrorException, SyncServiceErrorException {
		...
		if (Debug.infoOn())
			Debug.logInfo("Finished saveFinalSyncResults [" + entitySyncId + "]: totalRows=" + totalRows + ", totalRowsToCreate=" + totalRowsToCreate + ", totalRowsToStore=" + totalRowsToStore + ", totalRowsToRemove=" + totalRowsToRemove, module);
	}
	...
	public static class SyncOtherErrorException extends SyncErrorException {
		...
		public SyncOtherErrorException(String str, List<Object> errorMsgList, Map<String, Object> errorMsgMap, Map<String, Object> nestedServiceResult, Throwable nested) {
			super(str, errorMsgList, errorMsgMap, nestedServiceResult, nested);
		}
	...
	public static class SyncDataErrorException extends SyncErrorException {
		...
		public SyncDataErrorException(String str, List<Object> errorMsgList, Map<String, Object> errorMsgMap, Map<String, Object> nestedServiceResult, Throwable nested) {
			super(str, errorMsgList, errorMsgMap, nestedServiceResult, nested);
		}
	...
	public static class SyncServiceErrorException extends SyncErrorException {
		...
		public SyncServiceErrorException(String str, List<Object> errorMsgList, Map<String, Object> errorMsgMap, Map<String, Object> nestedServiceResult, Throwable nested) {
			super(str, errorMsgList, errorMsgMap, nestedServiceResult, nested);
		}
